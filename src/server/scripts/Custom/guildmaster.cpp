...
#define MSG_GOSSIP_TELE          "Переместиться в дом гильдии."
...
#define MSG_INCOMBAT             "Вы находитесь в бою, вы не можете быть перемещены в дом гильдии."
#define MSG_NOGUILDHOUSE         "Ваша гильдия не имеет дома гильдии."
...
#define MSG_NOTINGUILD           "Вы должны быть в гильдии прежде чем использовать дом гильдии."
...
bool OnGossipSelectWithCode(Player *player, Creature *_creature,
