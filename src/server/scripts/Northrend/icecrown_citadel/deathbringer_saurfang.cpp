    ...
    void UpdateAI(const uint32 uiDiff)
    {
        ...
        if (m_uiBoilingBloodTimer < uiDiff)
        {
            if (Unit* pTarget = SelectUnit(SELECT_TARGET_RANDOM, 1))
                DoCast(pTarget, RAID_MODE(SPELL_BOILING_BLOOD_10_NORMAL,SPELL_BOILING_BLOOD_25_NORMAL,SPELL_BOILING_BLOOD_10_HEROIC,SPELL_BOILING_BLOOD_25_HEROIC));
            m_uiBoilingBloodTimer = 20000;
