...
struct instance_icecrown_citadel_InstanceMapScript : public InstanceScript
{
    ...
    void OnCreatureCreate(Creature* pCreature, bool add)
    {
		...
		case 37025: uiStinky = pCreature->GetGUID(); break;
		case 37217: uiPrecious = pCreature->GetGUID(); break;
        case 36678: uiProfessorPutricide = pCreature->GetGUID(); break;
		case 37672: uiAbomination = pCreature->GetGUID(); break;
		...
		case 37533: uiRimefang = pCreature->GetGUID(); break;
		case 37534: uiSpinestalker = pCreature->GetGUID(); break;
...
/*      case DATA_GUNSHIP_BATTLE_EVENT:
		...
		if (data == DONE) //add emblem of frost after boss is died
		{
			...
			for (Map::PlayerList::const_iterator i = PlList.begin(); i != PlList.end(); ++i)
			{
				...
				{
					pPlayer->StoreNewItemInBestSlots(49426, 2); //need correct function
				}
			}
