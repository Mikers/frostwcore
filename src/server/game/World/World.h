...
enum WorldConfigs
{
    ...
    CONFIG_START_COMMAND_SEND_PLAYER_TO_GRAVEYAR,
	...
	CONFIG_ANTIHONOR,
	CONFIG_ARENA_HISTORY,
	CONFIG_CUSTOM_COMMADS,
        AnticheatHelpGM,
	CONFIG_ANTIDODGE,
...
class World
{
    public:
		...
		void SendCustomCommands();
		std::vector<uint32> commandq;
		CliCommandHolder::Print* zprint_;
