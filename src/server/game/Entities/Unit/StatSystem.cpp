...
{
    if (apply)
        m_baseFeralAP+=amount;
    else 
    {
        if (m_baseFeralAP-amount >= 0)
            m_baseFeralAP-=amount;
        else
            m_baseFeralAP = 0;
    }
...
{
    if (apply)
        m_baseHealthRegen+=amount;
    else 
    {
        if (m_baseHealthRegen-amount >= 0)
            m_baseHealthRegen-=amount;
        else
            m_baseHealthRegen = 0;
    }
