...
void BossSpellWorker::LoadSpellTable()
{
    ...
    if (Result)
    {
        ...
        do
        {
            ...
            if (bossEntry != bossID) sLog.outDebug("BSW: Unknown error while load boss_spell_table");
    ...
    {
        sLog.outDebug("BSW: Boss spell table for boss %u is empty.", bossID);
        _bossSpellCount = 0;
    };
}
