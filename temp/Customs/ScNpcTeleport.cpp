...
void LoadNpcTele(void)
{
    ...
    if (result)
    {
        sLog.outDebug("TSCR: Loading %s, %s and %s...", Table[0], Table[1], Table[2]);
        ...
        sLog.outDebug("");
        sLog.outDebug("TSCR: >> Loaded %u npc_teleport.", nbDest);
    } else sLog.outDebug("TSCR: WARNING >> Loaded 0 npc_teleport.");
}
